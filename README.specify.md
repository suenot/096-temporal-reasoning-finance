# Chapter 258: Temporal Reasoning Finance

## Описание

Временное рассуждение в финансовых текстах.
...
1. **Temporal Reasoning in NLP: A Survey**
   - URL: https://arxiv.org/abs/2108.02134
   - Год: 2021

## Структура
```
258_temporal_reasoning_finance/
├── README.specify.md
├── docs/ru/
├── python/
└── rust/src/
